...
void twophasekOmega2006<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/
    (
...
template<class BasicTurbulenceModel>
twophasekOmega2006<BasicTurbulenceModel>::twophasekOmega2006
(
...
template<class BasicTurbulenceModel>
bool twophasekOmega2006<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void twophasekOmega2006<BasicTurbulenceModel>::correct()
{
