...
void twophasekOmegaSASadvzeta1<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/
    (
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> twophasekOmegaSASadvzeta1<BasicTurbulenceModel>::Qsas
(
...
template<class BasicTurbulenceModel>
twophasekOmegaSASadvzeta1<BasicTurbulenceModel>::twophasekOmegaSASadvzeta1
(
...
template<class BasicTurbulenceModel>
bool twophasekOmegaSASadvzeta1<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void twophasekOmegaSASadvzeta1<BasicTurbulenceModel>::correct()
{
    ...
    if (writeTke_)
    {
        #include "writeTKEBudget_kOmegaSASadvzeta1.H"
    }
    omegaEqn.ref().relax();
