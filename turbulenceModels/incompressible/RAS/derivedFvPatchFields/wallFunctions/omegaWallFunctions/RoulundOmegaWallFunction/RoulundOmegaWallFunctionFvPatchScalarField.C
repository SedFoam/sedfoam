...
#include "RoulundOmegaWallFunctionFvPatchScalarField.H"
...
scalar RoulundOmegaWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void RoulundOmegaWallFunctionFvPatchScalarField::checkType()
{
    if (!isA<wallFvPatch>(patch()))
    {
        FatalErrorIn("RoulundOmegaWallFunctionFvPatchScalarField::checkType()")
...
void RoulundOmegaWallFunctionFvPatchScalarField::writeLocalEntries(Ostream& os) const
{
...
void RoulundOmegaWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchI)
    {
        if (isA<RoulundOmegaWallFunctionFvPatchScalarField>(bf[patchI]))
        {
            RoulundOmegaWallFunctionFvPatchScalarField& opf = omegaPatch(patchI);
...
void RoulundOmegaWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->dimensionedInternalField());
...
RoulundOmegaWallFunctionFvPatchScalarField&
RoulundOmegaWallFunctionFvPatchScalarField::omegaPatch(const label patchI)
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->dimensionedInternalField());
    ...
    const RoulundOmegaWallFunctionFvPatchScalarField& opf =
        refCast<const RoulundOmegaWallFunctionFvPatchScalarField>(bf[patchI]);

    return const_cast<RoulundOmegaWallFunctionFvPatchScalarField&>(opf);
}


void RoulundOmegaWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void RoulundOmegaWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbulence,
...
//    const scalar Cmu25 = pow025(Cmu_);
    ...
    forAll(nutw, faceI)
    {
        ...
        if (knplus<=20.2e0)
          {
            SR = pow(40e0/knplus,3);
          }
        else
          {
            SR = 100e0/pow(knplus,0.85);
          }
...
RoulundOmegaWallFunctionFvPatchScalarField::RoulundOmegaWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
RoulundOmegaWallFunctionFvPatchScalarField::RoulundOmegaWallFunctionFvPatchScalarField
(
    const RoulundOmegaWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
RoulundOmegaWallFunctionFvPatchScalarField::RoulundOmegaWallFunctionFvPatchScalarField
(
    const RoulundOmegaWallFunctionFvPatchScalarField& owfpsf
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
///*
scalarField& RoulundOmegaWallFunctionFvPatchScalarField::G(bool init)
{
...
scalarField& RoulundOmegaWallFunctionFvPatchScalarField::omega(bool init)
{
    if (patch().index() == master_)
    {
        if (init)
...
void RoulundOmegaWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void RoulundOmegaWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void RoulundOmegaWallFunctionFvPatchScalarField::write(Ostream& os) const
{
