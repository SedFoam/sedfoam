...
###############################################################################
ax[0][1].plot(-chan_data[:, 5], chan_data[:, 0], 'k', lw=1,
              label=r'$Chan$', dashes=(4, 2))
...
###############################################################################
ax[1][0].plot(chan_data[:, 6], chan_data[:, 0], 'k', lw=1,
              label=r'$Chan$', dashes=(4, 2))
...
###############################################################################
ax[1][1].plot(chan_data[:, 1], chan_data[:, 0], 'k', lw=1,
              label=r'$Chan[\epsilon]$', dashes=(4, 2))
