...
gs = plt.GridSpec(5, 4)
gs.update(left=0.08, right=0.975, top=0.95, bottom=0.15, wspace=0.2,
          hspace=1.)
...
ax1.plot(t[0]*360/period, sin[0], 'ro', markersize=10,
         markeredgecolor='maroon')
ax1.plot(t[13]*360/period, sin[13], 'ro', markersize=10,
         markeredgecolor='maroon')
ax1.plot(t[25]*360/period, sin[25], 'ro', markersize=10,
         markeredgecolor='maroon')
ax1.plot(t[37]*360/period, sin[37], 'ro', markersize=10,
         markeredgecolor='maroon')
ax1.text(6, -0.8, r'A')
ax1.text(44, -0.5, r'B')
ax1.text(88, -0.3, r'C')
...
plt.savefig('Figures/tuto3DOscillSheetFlow.png', facecolor='w', edgecolor='w',
            format='png')
plt.show()
