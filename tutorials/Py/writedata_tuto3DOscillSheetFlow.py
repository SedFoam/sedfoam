...
if write_alpha:
    ...
    for i, time in enumerate(time_list[1:n_div]):
        alpha1 = fluidfoam.readscalar(sol, time, 'alpha_a', True,
                                      precision=12)
        alpha2 = fluidfoam.readscalar(sol, time_list[i+n_div+1], 'alpha_a',
                                      True, precision=12)
        alpha3 = fluidfoam.readscalar(sol, time_list[i+2*n_div+1], 'alpha_a',
                                      True, precision=12)
        alpha4 = fluidfoam.readscalar(sol, time_list[i+3*n_div+1], 'alpha_a',
                                      True, precision=12)
...
if write_ub:
    ...
    for i, time in enumerate(time_list[1:n_div]):
        ...
        ub2 = fluidfoam.readvector(sol, time_list[i+n_div+1], 'Ub', True,
                                   precision=12)
        ub3 = fluidfoam.readvector(sol, time_list[i+2*n_div+1], 'Ub', True,
                                   precision=12)
        ub4 = fluidfoam.readvector(sol, time_list[i+3*n_div+1], 'Ub', True,
                                   precision=12)
...
if write_ua:
    ...
    for i, time in enumerate(time_list[1:n_div]):
        ...
        ua2 = fluidfoam.readvector(sol, time_list[i+n_div+1], 'Ua', True,
                                   precision=12)
        ua3 = fluidfoam.readvector(sol, time_list[i+2*n_div+1], 'Ua', True,
                                   precision=12)
        ua4 = fluidfoam.readvector(sol, time_list[i+3*n_div+1], 'Ua', True,
                                   precision=12)
