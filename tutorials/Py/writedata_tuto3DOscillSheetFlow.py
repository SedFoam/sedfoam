...
if write_alpha:
    ...
    for i, time in enumerate(time_list[0:n_div]):
        alpha1 = fluidfoam.readscalar(sol, time, 'alpha_a', True,
                                      precision=12)
        alpha2 = fluidfoam.readscalar(sol, time_list[i+n_div], 'alpha_a',
                                      True, precision=12)
        alpha3 = fluidfoam.readscalar(sol, time_list[i+2*n_div], 'alpha_a',
                                      True, precision=12)
        alpha4 = fluidfoam.readscalar(sol, time_list[i+3*n_div], 'alpha_a',
                                      True, precision=12)
        alpha_a = (np.mean(np.mean(alpha1, 2), 0)
                   + np.mean(np.mean(alpha2, 2), 0)
                   + np.mean(np.mean(alpha3, 2), 0)
                   + np.mean(np.mean(alpha4, 2), 0))/4
...
if write_ub:
    ...
    ubprim_file = rootgrp_uu.createVariable('UbPrim',
                                            np.float64, ('prim', 'n', 'p'))
    pos_file_u[:] = yi
    ...
    for i, time in enumerate(time_list[0:n_div]):
        ...
        ub2 = fluidfoam.readvector(sol, time_list[i+n_div], 'Ub', True,
                                   precision=12)
        ub3 = fluidfoam.readvector(sol, time_list[i+2*n_div], 'Ub', True,
                                   precision=12)
        ub4 = fluidfoam.readvector(sol, time_list[i+3*n_div], 'Ub', True,
                                   precision=12)
        ub_a = (np.mean(np.mean(ub1, 3), 1) + np.mean(np.mean(ub2, 3), 1)
                + np.mean(np.mean(ub3, 3), 1) + np.mean(np.mean(ub4, 3), 1))/4
        ub_file[:, :, i] = ub_a
        ...
        ubprim3 = ub3 - ub_abox
        ubprim4 = ub4 - ub_abox
        urms_a = np.sqrt(np.mean(
                         np.mean((ubprim1[0, :, :, :]*ubprim1[0, :, :, :]
                                 + ubprim2[0, :, :, :]*ubprim2[0, :, :, :]
                                 + ubprim3[0, :, :, :]*ubprim3[0, :, :, :]
                                 + ubprim4[0, :, :, :]*ubprim4[0, :, :, :])/4,
                                 2), 0))
        vrms_a = np.sqrt(np.mean(
                         np.mean((ubprim1[1, :, :, :]*ubprim1[1, :, :, :]
                                 + ubprim2[1, :, :, :]*ubprim2[1, :, :, :]
                                 + ubprim3[1, :, :, :]*ubprim3[1, :, :, :]
                                 + ubprim4[1, :, :, :]*ubprim4[1, :, :, :])/4,
                                 2), 0))
        wrms_a = np.sqrt(np.mean(
                          np.mean((ubprim1[2, :, :, :]*ubprim1[2, :, :, :]
                                  + ubprim2[2, :, :, :]*ubprim2[2, :, :, :]
                                  + ubprim3[2, :, :, :]*ubprim3[2, :, :, :]
                                  + ubprim4[2, :, :, :]*ubprim4[2, :, :, :])/4,
                                  2), 0))
        uv_a = np.mean(np.mean((ubprim1[0, :, :, :]*ubprim1[1, :, :, :]
                               + ubprim2[0, :, :, :]*ubprim2[1, :, :, :]
                               + ubprim3[0, :, :, :]*ubprim3[1, :, :, :]
                               + ubprim4[0, :, :, :]*ubprim4[1, :, :, :])/4,
                               2), 0)
...
if write_ua:
    ...
    uaprim_file = rootgrp_uu.createVariable('UaPrim', np.float64, ('prim', 'n',
                                                                   'p'))
    pos_file_u[:] = yi
    phase_file_u[:] = np.linspace(0, 5, n_div)
    pos_file_uu[:] = yi
    ...
    for i, time in enumerate(time_list[0:n_div]):
        ...
        ua2 = fluidfoam.readvector(sol, time_list[i+n_div], 'Ua', True,
                                   precision=12)
        ua3 = fluidfoam.readvector(sol, time_list[i+2*n_div], 'Ua', True,
                                   precision=12)
        ua4 = fluidfoam.readvector(sol, time_list[i+3*n_div], 'Ua', True,
                                   precision=12)
        ua_a = (np.mean(np.mean(ua1, 3), 1) + np.mean(np.mean(ua2, 3), 1) 
              + np.mean(np.mean(ua3, 3), 1) + np.mean(np.mean(ua4, 3), 1))/4
        ua_file[: ,:, i] = ua_a
        ...
        uaprim4 = ua4 - ua_abox
        urms_a =  np.sqrt(np.mean(
                          np.mean((uaprim1[0, :, :, :]*uaprim1[0, :, :, :] 
                                 + uaprim2[0, :, :, :]*uaprim2[0, :, :, :] 
                                 + uaprim3[0, :, :, :]*uaprim3[0, :, :, :] 
                                 + uaprim4[0, :, :, :]*uaprim4[0, :, :, :])/4,
                                   2), 0)) 
        vrms_a =  np.sqrt(np.mean(
                          np.mean((uaprim1[1, :, :, :]*uaprim1[1, :, :, :] 
                                 + uaprim2[1, :, :, :]*uaprim2[1, :, :, :] 
                                 + uaprim3[1, :, :, :]*uaprim3[1, :, :, :] 
                                 + uaprim4[1, :, :, :]*uaprim4[1, :, :, :])/4,
                                   2), 0)) 
        wrms_a =  np.sqrt(np.mean(
                          np.mean((uaprim1[2, :, :, :]*uaprim1[2, :, :, :] 
                                 + uaprim2[2, :, :, :]*uaprim2[2, :, :, :]
                                 + uaprim3[2, :, :, :]*uaprim3[2, :, :, :] 
                                 + uaprim4[2, :, :, :]*uaprim4[2, :, :, :])/4,
                                   2), 0)) 
        uv_a =  np.mean(np.mean((uaprim1[0, :, :, :]*uaprim1[1, :, :, :] 
                                 + uaprim2[0, :, :, :]*uaprim2[1, :, :, :] 
                                 + uaprim3[0, :, :, :]*uaprim3[1, :, :, :] 
                                 + uaprim4[0, :, :, :]*uaprim4[1, :, :, :])/4,
                                   2), 0)
